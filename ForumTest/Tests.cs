...
namespace ForumTest
{
    public class Tests
    {
        ...
        public Mock<IIdentity>              MockIdentity = new Mock<IIdentity>();
        ...
        public void InitData()
        {
            ...
            {
                new ForumComment { ID = 1, ForumPostId = 1, ForumUserId = "1", Text = "Comment1 Forum1", Date = DateTime.Now },
                new ForumComment { ID = 2, ForumPostId = 1, ForumUserId = "1", Text = "Comment2 Forum1", Date = DateTime.Now },
                new ForumComment { ID = 3, ForumPostId = 2, ForumUserId = "1", Text = "Comment3 Forum2", Date = DateTime.Now }
            }.AsQueryable();
